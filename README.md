...
## Introduction
 ...
 ![logo]([data_viz/logo.jpeg](https://github.com/xerowphyte/github.io/blob/main/Data%20Viz/logo.jpeg))
...
The heat map up top reveals that Cyclistic is most popular during the summer. The heat map also shows that the weekends are the busiest time of the week. Similar to most popular station's map, this emphasizes that most riders are doing so for pleasure.
